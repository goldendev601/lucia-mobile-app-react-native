...
interface IAccountCreatedScreenProps {
  navigation: NavigationProp<any>;
}

const AccountCreatedScreen: React.FC<IAccountCreatedScreenProps> = (props) => {
    ...
    <View style={styles.wrapper}>
      ...
      >
        ...
        <View style={styles.container}>
          <View style={styles.titleWrapper}>
            <Text style={[styles.title, {fontFamily: 'Cormorant'}]}>Account Successfully</Text>
            <Text style={[styles.title, {fontFamily: 'Cormorant'}]}>Created!</Text>
          </View>
      ...
      <View style={styles.buttonContainer}>
          <Pressable style={styles.signupButton} onPress={gotoLogin}>
            <Text style={[styles.signupButtonText, {fontFamily: 'Montserrat'}]}>Go to Login</Text>
          </Pressable>
      </View>
