...
interface IVerificationRecoveryPasswordInfoScreenProps {
  navigation: NavigationProp<any>;
}

const CELL_COUNT = 6;

const VerificationRecoveryPasswordInfoScreen: React.FC<
  IVerificationRecoveryPasswordInfoScreenProps
> = (props) => {
  ...
  const { isSentVerificationCode } = useSelector(
  ...
  const gotoUpdatePassword = () => {
    ...
    navigation.navigate('UpdatePasswordInfoScreen');
  };
...
export default VerificationRecoveryPasswordInfoScreen;
