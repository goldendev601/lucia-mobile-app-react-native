...
import { clearPersonalUpdatedFlag, getAvatars} from '../actions/luciaAppAction';
...
interface IAuthPickAvatarScreenProps {
    navigation: NavigationProp<any>;
}

const AuthPickAvatarScreen: React.FC<IAuthPickAvatarScreenProps> = (props) => {
    ...
    const { avatars } = useSelector((state: IRootState) => state.luciaApp);
                        ...
                        renderItem={({ item }) => (
                            <View style={styles.avatarView}>
                                <Pressable
                                    ...
                                    style={item === profileImage ? styles.imageWrapperSelected : styles.imageWrapper}
                                >
...
export default AuthPickAvatarScreen;
