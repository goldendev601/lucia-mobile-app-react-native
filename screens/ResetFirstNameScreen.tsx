...
import { clearPersonalUpdatedFlag, sendValidationToken, setNewEmailInfo, setNewPhoneInfo, updateFirstName } from '../actions/luciaAppAction';
...
interface IResetFirstNameScreenProps {
  navigation: NavigationProp<any>;
}

const ResetFirstNameScreen: React.FC<IResetFirstNameScreenProps> = (props) => {
  ...
  const saveChanges = () => {
    if (newFirstName) {
      ...
      setValidationErrorMessage(
        'Please fill your new first name.'
      );
    }
  };
      ...
      >
        ...
        <View style={styles.container}>
          <View style={styles.titleWrapper}>
            {
              fontsLoaded && (
                <Text style={[styles.title, {fontFamily: 'Cormorant'}]}>Update First Name</Text>
              )
            }
          </View>
          <View style={styles.textContainer}>
            {/* <Text style={[styles.fieldLabel, {fontFamily: 'Cormorant'}]}>Current First Name</Text>
            
            <View style={styles.fieldWrapper}>
              <TextInput
                style={[styles.fieldInput, {fontFamily: 'Montserrat'}]}
                placeholder="Enter your current first name"
                onChangeText={(text) => setFirstName(text)}
                placeholderTextColor="rgba(255, 255, 255, 0.5)"
              />
            </View> */}
            <Text style={[styles.fieldLabel, {fontFamily: 'Cormorant'}]}>New First Name</Text>
            <View style={styles.fieldWrapper}>
              <TextInput
                style={[styles.fieldInput, {fontFamily: 'Montserrat'}]}
...
export default ResetFirstNameScreen;
