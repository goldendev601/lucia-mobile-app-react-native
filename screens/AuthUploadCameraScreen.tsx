...
import { StyleSheet, Pressable, Image, FlatList, SafeAreaView } from 'react-native';
...
interface IAuthUploadCameraScreenProps {
    navigation: NavigationProp<any>;
}

const AuthUploadCameraScreen: React.FC<IAuthUploadCameraScreenProps> = (props) => {
...
export default AuthUploadCameraScreen;
